...
//     -m '{"file": "/Hauzman.bin", "server": "www.example.com", "port": 8080 }'
//
                            ...
                            const char *value_template)
{
    ...
    json["device"]["manufacturer"] = "Hauzman Technology";
...
{
    sensor_line1 = "Temperature " + formatTemperature(dhtTemperature);
